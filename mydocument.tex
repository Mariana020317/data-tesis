...
\begin{table}[htbp]
\centering
\caption{Asociación entre edad de los padres y riesgo en dominios del desarrollo}
\label{tab:edad_padres_desarrollo}
\begin{threeparttable}
\begin{tblr}{
  width = 0.97\linewidth,
  colspec = {X[1.2,l]X[0.9,l]X[1.0,c]X[1.0,c]X[1.0,c]X[0.9,c]X[0.9,c]},
  row{1} = {font=\bfseries, bg=gray!10},
  row{even} = {bg=gray!3},
  cells = {valign=m, font=\footnotesize},
  hline{1,2,Z} = {1pt},
...
\textbf{Padre/Madre} & \textbf{Dominio} & \textbf{F/W} & \textbf{\textit{p}-valor} & \textbf{Significativo} & \textbf{Método} & \textbf{N} \\
Madre  & Comunicación          & 0.67 & 0.616 & No & ANOVA & 1714 \\
Madre  & Motricidad gruesa     & 0.77 & 0.547 & No & ANOVA & 1714 \\
Madre  & Motricidad fina       & 1.06 & 0.374 & No & ANOVA & 1714 \\
Madre  & Resolución de problemas & 1.87 & 0.113 & No & ANOVA & 1714 \\
Madre  & Socio-individual      & 1.77 & 0.132 & No & ANOVA & 1714 \\
Padre  & Comunicación          & 0.37 & 0.829 & No & ANOVA & 1674 \\
Padre  & Motricidad gruesa     & 1.22 & 0.298 & No & ANOVA & 1674 \\
Padre  & Motricidad fina       & 1.74 & 0.138 & No & ANOVA & 1674 \\
Padre  & Resolución de problemas & 1.03 & 0.388 & No & ANOVA & 1674 \\
Padre  & Socio-individual      & 0.10 & 0.984 & No & ANOVA & 1674 \\
\end{tblr}
\begin{tablenotes}
\footnotesize
\item No se encontraron asociaciones significativas entre la edad de la madre o padre y el riesgo en ningún dominio del desarrollo infantil (\textit{p} $>$ 0.05 en todos los casos).
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Asociación entre el total de personas en el hogar y riesgo en dominios del desarrollo}
\label{tab:total_personas_hogar_desarrollo}
\begin{threeparttable}
\begin{tblr}{
...
\begin{tablenotes}
\footnotesize
\item No se encontraron asociaciones significativas entre el total de personas en el hogar y el riesgo en ningún dominio del desarrollo infantil (\textit{p} $>$ 0.05 en todos los casos).
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Asociación entre el número de controles prenatales y riesgo en dominios del desarrollo}
\label{tab:controles_prenatales_desarrollo}
\begin{threeparttable}
\begin{tblr}{
  width = 0.85\linewidth,
  colspec = {X[1.4,l]X[0.8,c]X[1.0,c]X[1.0,c]X[1.0,c]X[0.7,c]},
...
\begin{tablenotes}
\footnotesize
\item No se encontraron asociaciones significativas entre el número de controles prenatales y el riesgo en ningún dominio del desarrollo infantil (\textit{p} $>$ 0.05 en todos los casos).
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Asociación de vitaminas prenatales con el neurodesarrollo}
\label{tab:asoc_vitaminas_prenatales}
\begin{threeparttable}
\begin{tblr}{
  width = 0.99\linewidth,
  colspec = {X[1.3,l]X[0.9,c]X[1.0,c]X[1.0,c]X[1.2,c]X[1.2,c]X[1.1,c]},
  row{1} = {font=\bfseries, bg=gray!10},
  row{even} = {bg=gray!3},
  cells = {valign=m, font=\footnotesize},
  hline{1,2,Z} = {1pt},
...
\textbf{Grupo} & \textbf{Dominio} & \textbf{Chi-cuadrado} & \textbf{p-valor} & \textbf{OR} & \textbf{IC 95\%} & \textbf{Significativo} \\
Prenatales 1er trimestre & Comunicación         & 0.43 & 0.511 & -- & -- & No \\
Prenatales 1er trimestre & Motricidad gruesa    & 2.21 & 0.137 & -- & -- & No \\
Prenatales 1er trimestre & Motricidad fina      & 0.07 & 0.791 & -- & -- & No \\
Prenatales 1er trimestre & Resolución problemas & 2.33 & 0.127 & -- & -- & No \\
Prenatales 1er trimestre & Socio-individual     & 1.84 & 0.175 & -- & -- & No \\
Prenatales resto embarazo & Comunicación         & 0.02 & 0.883 & -- & -- & No \\
Prenatales resto embarazo & Motricidad gruesa    & 0.62 & 0.430 & -- & -- & No \\
Prenatales resto embarazo & Motricidad fina      & 1.83 & 0.176 & -- & -- & No \\
Prenatales resto embarazo & Resolución problemas & 0.27 & 0.604 & -- & -- & No \\
Prenatales resto embarazo & Socio-individual     & 0.00 & 1.000 & -- & -- & No \\
\end{tblr}
\begin{tablenotes}
\footnotesize
\item \textbf{Nota:} No se encontró ninguna asociación significativa entre el
uso de vitaminas prenatales, ni en el primer trimestre ni en el resto del
embarazo, y el neurodesarrollo en ninguno de los dominios evaluados.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
edad materna y paterna ($p > 0.05$ en todos los dominios) 
(Cuadro~\ref{tab:edad_padres_desarrollo}), total de personas en el hogar 
($p > 0.05$ en todos los dominios) 
(Cuadro~\ref{tab:total_personas_hogar_desarrollo}), número de controles 
prenatales ($p > 0.05$ en todos los dominios) 
(Cuadro~\ref{tab:controles_prenatales_desarrollo}), vitaminas prenatales 
...
Los resultados confirman que el riesgo en neurodesarrollo está influenciado 
por múltiples factores sociodemográficos, educativos, nutricionales y de 
estimulación, con patrones específicos según dominio evaluado. La motricidad 
gruesa presenta mayor vulnerabilidad, mientras que factores como etnia, área 
de residencia, educación materna y patrones de estimulación muestran 
asociaciones significativas con riesgo en desarrollo.

Las disparidades observadas reflejan inequidades sociales más amplias que 
requieren abordaje multisectorial coordinado entre sectores de salud, educación 
y desarrollo social para promover desarrollo infantil óptimo en la población 
estudiada.
